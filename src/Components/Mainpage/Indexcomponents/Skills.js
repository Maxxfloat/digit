...
const Skills = () => {
    return (
        <section className={style.height}>
            <Container fluid>
                    <Row className='justify-content-center align-items-top my-5'>
                        <h1 className='col-xl-12 text-center display-1 mb-4'>مهارت ها</h1>
                        <div className='row col-12 m-0 align-items-top'>
                            ...
                            <div className='col-xl-4 my-sm-4 text-center'>
                            ...
                            <div className='col-xl-4 text-center'>
                                <i className={` fa fa-google ${style.textInlineGradient}`}
